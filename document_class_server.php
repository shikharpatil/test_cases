		...
		try
		{
			...
			else
			{
				...
				foreach ($dataInLeaves as $key => $value)
				{
					...
					$alert=$web_driver->findElements(WebDriverBy::id("popup_message"));
					if(!empty($alert))
					{
						$web_driver->wait()->until(WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::id("popup_ok")));

						$web_driver->findElement(WebDriverBy::id("popup_ok"))->click();
						// /html/body/div[5]/div[2]/form/div/div/span/div/a[2]
						
						$web_driver->wait()->until(WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::id("cancelFirstLeaf")));
						$web_driver->findElement(WebDriverBy::id("cancelFirstLeaf"))->click();
					}
					...
					// /html/body/div[8]/div
						...
						if(!empty($alert))
						{
							...
							$web_driver->wait()->until(WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::id("popup_ok")));
							// /html/body/div[9]/div/div[2]/input
						...
						//*[@id="frmEditLeaf"]
						// /html/body/div[5]/div[2]/form
						// $web_driver->findElement(WebDriverBy::xpath(""));
					$is_editor_open=$web_driver->findElement(WebDriverBy::id("leafAddFirst"))->isDisplayed();
					if($is_editor_open==false)
					{
						$web_driver->findElement(WebDriverBy::id("aAddNewNote"))->click();
					}
					...
					echo " content added ";
					$is_draft=$web_driver->findElement(WebDriverBy::id("SaveAsDraftLeafFirst"))->isDisplayed();
					...
					// $editor_open=$web_driver->findElements(WebDriverBy::xpath("/html/body/div[5]/div[2]/form/div/div/div/div[3]/div/p"));
